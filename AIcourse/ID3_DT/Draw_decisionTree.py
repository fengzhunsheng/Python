# -*- coding: utf-8 -*-
"""
Created on Tue Oct 22 22:43:35 2019
@file:  Draw_decisionTree.py
@brief: this file could draw the decision tree.
...
def plot_mid_text(center_point, parent_point, txt_str):
    ...
    createPlot.ax1.text(x_mid, y_mid, txt_str, fontsize=16)
    return
